...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Tidy Data Validation Infrastructure",
    Description = "Simplify the workflow needed to use the tools available in the 'validate' package.",
    Version = "0.0.0.9000",
    Encoding = "UTF-8",
    `Authors@R` = c(
      person("Angel", "Feliz", email = "angel.esteban.feliz@gmail.com", role = c("aut", "cre"))
    )
  )
)
...
# Code of Conduct
usethis::use_code_of_conduct("angel.esteban.feliz@gmail.com")
# NEWS
usethis::use_news_md()
```
